				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						...
						<div class="portlet-body form">
							...
							<?php if (isset($conteudos[0]->idCadastro)) { ?><input name="idCadastro" type="hidden" value="<?php echo $conteudos[0]->idCadastro; ?>"><?php } ?>
								<div class="form-body">
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input value="<?php if (isset($conteudos[0]->dsNome)) echo $conteudos[0]->dsNome; ?>" type="text" name="dsNome" class="form-control"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-6">
											<input value="<?php if (isset($conteudos[0]->dsEmail)) echo $conteudos[0]->dsEmail; ?>" type="text" name="dsEmail" data-required="1" class="form-control"/>
										</div>
									</div>
