				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						...
						<div class="portlet-body form">
							...
							<?php if (isset($conteudos[0]->idUsuario)) { ?><input name="idUsuario" type="hidden" value="<?php echo $conteudos[0]->idUsuario; ?>"><?php } ?>
								<div class="form-body">
									...
									<div class="form-group">
										...
										* </span>
										...
										<div class="col-md-5">
											<input value="<?php if (isset($conteudos[0]->dsNome)) echo $conteudos[0]->dsNome; ?>" type="text" name="dsNome" data-required="1" class="form-control"/>
										</div>
									</div>
									
									<div class="form-group">
										<label class="control-label col-md-3">Login <span class="required">
										* </span>
										</label>
										<div class="col-md-5">
											<input value="<?php if (isset($conteudos[0]->dsLogin)) echo $conteudos[0]->dsLogin; ?>" type="text" name="dsLogin" data-required="1" class="form-control"/>
										</div>
									</div>
									
									<div class="form-group">
										<label class="control-label col-md-3">Senha <?php if ($acaoControl == 'salvar') echo '<span class="required">
										* </span>'; ?>
										</label>
										<div class="col-md-3">
											<input value="" type="password" name="dsSenha"<?php if ($acaoControl == 'salvar') echo ' data-required="1"'; else echo ' data-required="0"' ?> class="form-control"/>
										</div>
									</div>										
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<div class="fileupload fileupload-new" data-provides="fileupload">
													...
													<div>
	                                                    <a onclick="remover_imagem('idUsuario', <?php echo $conteudos[0]->idUsuario; ?>, '<?php echo base_url('painel/'. $this->pagina .'/remover_imagem') ?>')" href="javascript:;" class="btn red "><i class="fa fa-trash-o"></i> Remover Imagem</a>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="form-group last">
										...
										<div class="col-md-4">
											<div class="radio-list" data-error-container="#form_2_membership_error">
												<label>
												<input type="radio" name="snAtivo" value="S"<?php
												if (isset($conteudos[0]->snAtivo))
												{
												...
												Sim </label>
												<label>
												<input type="radio" name="snAtivo" value="N"<?php
												if (isset($conteudos[0]->snAtivo)) 
												{
