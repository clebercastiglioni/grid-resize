				...
				<div class="col-md-12">
					...
					<div class="portlet box green">
						...
						<div class="portlet-body form">
							...
							<?php if (isset($conteudos[0]->idBanner)) { ?><input name="idBanner" type="hidden" value="<?php echo $conteudos[0]->idBanner; ?>"><?php } ?>
								<div class="form-body">
									...
									<div class="form-group">
										<label class="control-label col-md-3">Ordem
										</label>
										<div class="col-md-1">
											<input value="<?php if (isset($conteudos[0]->sqOrdem)) echo $conteudos[0]->sqOrdem; ?>" type="text" name="sqOrdem" class="form-control"/>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-9">
											<textarea class="form-control" name="dsBanner" rows="4"><?php if (isset($conteudos[0]->dsBanner)) echo $conteudos[0]->dsBanner; ?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-md-6">
											<input value="<?php if (isset($conteudos[0]->dsLink)) echo $conteudos[0]->dsLink; ?>" type="text" name="dsLink" class="form-control"/>
										</div>
									</div>
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<div class="fileupload fileupload-new" data-provides="fileupload">
													...
													<div>
	                                                    <a onclick="remover_imagem('idBanner', <?php echo $conteudos[0]->idBanner; ?>, '<?php echo base_url('painel/'. $this->pagina .'/remover_imagem') ?>')" href="javascript:;" class="btn red "><i class="fa fa-trash-o"></i> Remover Imagem</a>
													</div>
												</div>
											</div>
										</div>
